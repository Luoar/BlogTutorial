...
import ch.luoar.blogtutorial.domain.Tag;
import ch.luoar.blogtutorial.repository.TagRepository;
...
/**
 * REST controller for managing {@link ch.luoar.blogtutorial.domain.Tag}.
 */
@RestController
@RequestMapping("/api")
@Transactional

...
import ch.luoar.blogtutorial.domain.Blog;
import ch.luoar.blogtutorial.repository.BlogRepository;
...
/**
 * REST controller for managing {@link ch.luoar.blogtutorial.domain.Blog}.
 */
@RestController
@RequestMapping("/api")
@Transactional
